            ...
            <Navbar/>
                <div className="gathering-main">
                {
                    gathering.length === 0 || new Date() > gatheringDate ? (
                        <Box width={'100%'} display={'flex'} justifyContent={'center'} alignItems={'center'} flexDirection={"column"} mt={14}>
                            <Typography fontSize={smallscreen ? '25px':'40px'} variant="p" fontFamily={'inherit'} textAlign={'center'}>Our next gathering date is to be determined.</Typography>
                            ...
                            <Typography fontSize={smallscreen ? '16px' : '30px'} variant="p" width={smallscreen ? '100%':'unset'} margin={'30px auto'} maxWidth={'900px'} fontFamily={'inherit'} textAlign={'center'}>
